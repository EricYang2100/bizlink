...
<script>
import { listTreeItem, getTreeItem, delTreeItem, addTreeItem, updateTreeItem } from '@/api/bizCell/docTreeItem'
...
export default {
  ...
  created() {
    ...
    this.getDicts('bizCell_doc_type').then(response => {
  ...
  methods: {
    ...
    handleCommand(command) {
      ...
      if (command.button === 'field') {
        ...
        this.$router.push('/bizCell/docTreeItem/field/' + command.row.docPath)
      }
    },
    // 字典状态字典翻译
