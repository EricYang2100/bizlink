<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="属性模板" align="center" prop="docDefinePath" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="属性模板" prop="docDefinePath">
          <el-input v-model="form.docDefinePath" placeholder="请输入属性模板" />
        </el-form-item>
...
<script>
import { listCategory, getCategory, delCategory, addCategory, updateCategory, exportCategory } from "@/api/bizdoc/category";
